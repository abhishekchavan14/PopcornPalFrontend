...
import BackgroundVideo from "../images/Background_Video_1.mp4"
...
export default function Hero() {
  return (
    ...
    <video src={BackgroundVideo} autoPlay muted loop className="absolute inset-0 w-full h-full object-cover z-[-2] opacity-30"></video>
    </>
  )
}
